              ...
              <figure className="wgh-slider-item-figure">
                <div className="slides">
                  ...
                  <div className="slider">
                    ...
                    <div className="image">
                      <img
                        src="https://image.shutterstock.com/image-photo/praise-lordwoman-worshipping-god-sunset-600w-248081164.jpg"
                        alt="pic3"
                      />
                    </div>
                  </div>
